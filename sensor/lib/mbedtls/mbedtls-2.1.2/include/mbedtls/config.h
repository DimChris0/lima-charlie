//=============================================================================
// This bit is custom to make polarssl easier to compile within LC
#include <rpal/rpal.h>
#ifdef RPAL_PLATFORM_WINDOWS
    // Since we're using the DDK and not the SDK we don't have access to stdint.h
    // so we will do the few definitions needed here.
    #include <basetsd.h>
    typedef RU32 uint32_t;
    typedef RS32 int32_t;
    typedef RU64 uint64_t;
    typedef RS64 int64_t;
    typedef RU16 uint16_t;
    #define _STDINT 
#endif
//=============================================================================
